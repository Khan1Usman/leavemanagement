...
<script type="text/javascript">
	function confirmPass() {
		...
		if (pass == '') {
			document.getElementById("pass1Errr").innerHTML = "Required !";
			return;
		}else{
			document.getElementById("pass1Errr").innerHTML = "";
		}
		if (pass != confPass) {
			// alert('Wrong confirm password !');
			document.getElementById("pass2Errr").innerHTML = "Password did not match !";
...
<body data-spy="scroll">
	<div>
		<form action="restorePassword" method="Post" id="confirmForm">
			Password : <input type="password" name="password" id="pass1">
			<span id="pass1Errr"></span> <br> Confirm Password :<input
				type="password" id="pass2"><input type="hidden"
				value="${username}" name="username"><span id="pass2Errr"></span><br> 
			<button type="button" onclick="confirmPass()">Submit</button>
		</form>
				...
				<div class="white_box">
					<ul class="company-social1" style="padding-left: 0;">
						...
						<c:if test="${not empty param.error}">
							<li><h1 class="login_txt" style="color: red; margin: 0px;">Bad
									Credentials</h1></li>
						</c:if>
					</ul>
						...
						<form:form method="POST" action="${loginUrl}" commandName="user"
							...
							<div class="checkbox">
								<label> <input type="checkbox" name="remember-me">
									Remember Me
								</label><a href="forgetPassword"><label class="pull-right"> Forget Password? </label></a>
