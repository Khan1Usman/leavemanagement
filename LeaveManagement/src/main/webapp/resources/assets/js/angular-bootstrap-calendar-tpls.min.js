...
(function (window, angular) {
    ...
    angular.module('mwl.calendar').directive('mwlCalendarYear', function () {
        return {
            templateUrl: './resources/assets/templates/calendarYearView.html',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarWeek', function () {
        return {
            templateUrl: './resources/assets/templates/calendarWeekView.html',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarSlideBox', function () {
        return {
            restrict: 'EA',
            templateUrl: './resources/assets/templates/calendarSlideBox.html',
            replace: true,
            controller: [
                '$scope',
                '$sce',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarMonth', function () {
        return {
            templateUrl: './resources/assets/templates/calendarMonthView.html',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendarDay', function () {
        return {
            templateUrl: './resources/assets/templates/calendarDayView.html',
            restrict: 'EA',
            require: '^mwlCalendar',
            scope: {
                events: '=',
    ...
    angular.module('mwl.calendar').directive('mwlCalendar', function () {
        return {
            templateUrl: './resources/assets/templates/calendar.html',
            restrict: 'EA',
            scope: {
                events: '=',
                view: '=',
